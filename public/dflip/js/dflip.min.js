    ...
    (function () {
      ...
      (u.removeNullCharacters = function (e) {
        ...
        (u.detectHash = function () {
          ...
          0 == t.indexOf("") && t.push(""),
            Array.prototype.every.call(u.getSharePrefixes(), function (t) {
              ...
              if (i && i.indexOf(t) >= 0 && !1 === e.hashFocusBookFound) {
                ...
                if (
                  (null != a && (a = a.split("/")[0]),
                  0 === (n = r("[data-slug=" + o + "]")).length &&
                    (n = r("#df-" + o + ",#" + o)),
                  0 === n.length && (n = r("[data-_slug=" + o + "]")),
                  n.length > 0 &&
                    n.is(
                  ...
                  return null != s
                    ? (s.gotoPage(a),
                      ...
                      !1)
                    : (null != a && n.attr("data-hash-page", a),
                      n.addClass("df-hash-focused", !0),
                      (null != n.data("lightbox") ||
                        (null != n.attr("href") &&
                          n.attr("href").indexOf(".pdf") > -1)) &&
                        n.trigger("click"),
                      !1);
                }
              }
      ...
      (u.getOptions = function (e) {
        null == (e = r(e)).data("option") &&
          e.data("option", "option_" + e.attr("id")),
          void 0 !== e.attr("source") && e.data("source", e.attr("source"));
        var i = e.data("option"),
          n = void 0;
        n =
          "object" === t(i)
        ...
        (u.urlify = function (e) {
          for (
            var t, i = /[a-z0-9][^\s,]{3,}\.[^\s,]+[a-z0-9]/gi, n = [];
            (t = i.exec(e));

          ) {
            var o = t[0];
            o.indexOf("@") > -1
              ? o.match(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/gi) &&
                n.push({ index: t.index, length: o.length, text: o })
              : o.match(
        ...
        (e.parseNormalElements = function () {
          r(".df-posts").each(function () {
            if (
              ...
              var t = r(this);
              if ("true" !== t.data("parsed")) {
                t.data("parsed", "true"), t.attr("df-parsed", "true");
                var i = 0,
                  n = t.find(".df-element"),
                  o = n.length;
                n.each(function () {
            ...
            r(".df-element").each(function () {
              ...
              if (
                ...
                if (void 0 === i)
                  ...
                  var n = t.data("thumb-layout") || e.defaults.thumbLayout,
                    o = u.httpsCorrection(t.data("thumb"));
            ...
            (e.handleLazy = function () {
              ...
              if (
                ...
                if (i.length > 0) {
                  var n = i.data("df-app");
                  n &&
                    (i.attr("data-page", n.currentPageNumber),
            ...
            x(i, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  function o() {
                    (t.textureSrc = i),
                      t.element.css({ backgroundImage: k.bgImage(i) }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new O({ parentElement: this.wrapper });
        ...
        K = (function (t) {
          ...
          return (
            U(n, [
                      ...
                      if (
                        ...
                        var a =
                          ...
                          (1 != t.options.sideMenuOverlay && t.isSideMenuOpen
                            ...
                            : 0);
                        this.pageMode =
                          t.dimensions.stage.innerHeight > 1.1 * a && a < 768
                            ? e.FLIPBOOK_PAGE_MODE.SINGLE
                            : e.FLIPBOOK_PAGE_MODE.DOUBLE;
                      }
                    this.pageMode != i &&
              ...
              { key: "finalizeTextContent", value: function (e, t) {} },
              {
                key: "isActivePage",
                value: function (e) {
                  return (
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (this.visiblePagesCache = t), { main: t, buffer: [] };
                },
              },
              {
                key: "getBasePage",
                  ...
                  if (
                    ...
                    r && "-1" === r.textureStamp
                      ? ((r.textureStamp = a.textureStamp),
                        r.loadTexture({ texture: a.getTexture(!0) }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  "vertical" == this.orientation && 0 == t && (o /= 2),
                    ...
                    (this._pageFitArea = { width: n, height: o });
              ...
              },
              {
                ...
                value: function (e) {
                  var t,
                    i = this.getViewPort(e.pageNumber, !0),
                    n =
                      null !== (t = e.pixelRatio) && void 0 !== t
                        ? t
                        : window.devicePixelRatio,
                    o = Z.contain(
                      i.width,
                      i.height,
                      n * this.availablePageWidth(e.zoom),
                      n * this.availablePageHeight(e.zoom)
                    );
                  return {
                    height: (o = Z.containUnStretched(
                      o.width,
                      o.height,
                    ...
                    !0 === i.isHard
                      ...
                      ? (n = i.init =
                          i && !0 === i.animateToReset
                            ? { x: r ? 0 : u, y: 0 }
                            : { x: r ? u : 0, y: 0 })
                      : ((n = i.init = { x: t.x, y: t.y, opacity: 1 }),
                        (p =
          ...
          return (
            te(n, [
              ...
              },
              {
                ...
                value: function () {
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new le({ parentElement: this.wrapper });
                    (t.index = e),
                      (t.viewer = this),
                      this.sheets.push(t),
            ...
            fe(i, [
              {
                ...
                value: function () {
                  var e = this,
                    t = (e.element = jQuery("<div>", { class: "df-sheet" }));
            ...
            fe(n, [
              {
                ...
                value: function () {
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new we({ parentElement: this.wrapper });
                    (t.index = e),
                      (t.viewer = this),
                      this.sheets.push(t),
                      this.pages.push(t.frontPage),
            ...
            ke(i, [
              {
                ...
                value: function () {
                  ...
                  (e.element = new Fe.Paper({
                    ...
                    (e.element.sheet = e),
                    (e.frontPage = new De({ sheet: e, face: 5 })),
                    (e.backPage = new De({ sheet: e, face: 4 })),
                    e.reset(),
                    e.updateAngle();
                },
              },
            ...
            ke(n, [
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this,
                    ...
                    n = { x: (e = _e.fixMouseEvent(e)).clientX, y: e.clientY };
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return this.texturePowerOfTwo ? { height: i, width: o } : t;
                },
              },
              {
                key: "getPageByNumber",
              ...
              },
              {
                ...
                value: function (e) {
                  var t =
                    ...
                    void 0 !== arguments[1] &&
                    arguments[1];
                  return this.zoomViewer.getAnnotationElement(e, t);
                },
              },
              {
                key: "getTextElement",
                value: function (e) {
                  var t =
                    ...
                    void 0 !== arguments[1] &&
                    arguments[1];
                  return this.zoomViewer.getTextElement(e, t);
                },
              },
              {
                key: "isAnimating",
        ...
        lt = (function (t) {
          ...
          function o(t, a) {
            ...
            var s,
              ...
              u = $e(r);
            function h(t) {
              (l.options.pdfjsWorkerSrc += "?ver=" + e.version),
                l.updateInfo(l.options.text.loading + " PDF Worker ...");
              var i = document.createElement("a");
              (i.href = l.options.pdfjsWorkerSrc),
            ...
            return (
              ...
              "undefined" == typeof pdfjsLib
                ? (l.updateInfo(l.options.text.loading + " PDF Service ..."),
                  at.getScript(
                    l.options.pdfjsSrc + "?ver=" + e.version,
                    function () {
                      "function" == typeof define && i.amdO && window.requirejs
                        ? (l.updateInfo(
              ...
              },
              {
                ...
                value: function (e, t) {
                  var i =
                    ...
                    void 0 !== arguments[2] &&
                    arguments[2];
                  if (null == (n = this).textContentJoined[t] || i) {
                    var n;
                    (n = this).textContent[t] = e.items.map(function (e) {
                      return 0 == e.hasEOL ? e.str : e.str + " ";
                    });
                    var o = 0,
                      a = 0;
                    (n.textOffset[t] = e.items.map(function (e, t) {
                      return {
                        length: (a =
                          (e.str.length || 0) + (0 == e.hasEOL ? 0 : 1)),
                        offset: (o += a) - a,
                      };
                    })),
          ...
          function e(t) {
            ...
            for (var i = 0; i < t.length; i++)
              (this.source[i] = mt.httpsCorrection(t[i].toString())),
                this.pages.push(new yt({ src: this.source[i] }));
          }
          return (
            vt(e, [
              {
        ...
        Rt = (function () {
          function t(e, i) {
            Ct(this, t),
              ...
              (this.element = kt("<div>", { class: "df-ui" })),
              (this.leftElement = kt("<div>", { class: "df-ui-left" }).appendTo(
                this.element
              )),
            ...
            xt(t, [
              {
                ...
                value: function () {
                  ...
                  (t.moreContainer = kt(i, { class: "df-more-container" })),
                ...
                value: function () {
                  ...
                  if ((e.container.toggleClass("df-search-open", n), n)) {
                    var o = e.searchContainer.find(
                      ".df-search-result[data-page=" + e.currentPageNumber + "]"
                    );
                    if (
                      (e.searchContainer
        ...
        _t = (function () {
          function e(t, i) {
            Ct(this, e),
              ...
              (this.element = kt("<div>", { class: "df-sidemenu-wrapper" })),
              this.parentElement.append(this.element),
              (this.buttons = kt("<div>", {
                ...
                value: function (t) {
                  ...
                  if (t.textureTarget === e.TEXTURE_TARGET.THUMB) {
                    ...
                    a
                      ...
                      a
                        .find(".df-bg-image")
                        .css({ backgroundImage: Et.bgImage(o) }),
                      a
      ...
      (e.openLightBox = function (t) {
          ...
          t
            ? (e.oldLocalFileObjectURL &&
              ...
              null === (i = e.openFileSelected) ||
                void 0 === i ||
                i.call(e, { url: e.oldLocalFileObjectURL, file: t }),
        ...
        (e.openBase64 = function (t) {
          (e.openFileOptions.source = null),
            (e.openFileOptions.pdfParameters = { data: atob(t) }),
            e.openURL();
        }),
          ...
          function t(i) {
            ...
            !(function (e, t) {
              ...
              (this.dimensions = {
                ...
                maxTextureSize:
                  null !== (n = i.maxTextureSize) && void 0 !== n ? n : 4096,
              }),
              (this.is3D = i.is3D),
              (this.events = {}),
              (this.links = i.links),
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: "initInfo",
                value: function () {
                  (this.info = Bt("<div>", { class: "df-loading-info" })),
                    ...
                    for (var u = 0; u < r.length; u++) {
                      ...
                      if (
                        ...
                        ((t = l
                          ...
                          : o.getPageByNumber(h)) &&
                          ((i = o.getTextureSize({ pageNumber: h })),
        ...
        for (
          ...
          for (; l >= r && l < s; ) {
            ...
            if (
              ...
              d.searchHits.push({ start: l - r, length: a, text: i[u].text }),
                ...
                i.pdfDocument.getPage(a).then(function (r) {
                  ...
                  (s = r.getViewport({
                    ...
                    r.getTextContent().then(function (r) {
                      ...
                      if (!0 === o && null == h) {
                        (h = []),
                          (p = u.urlify(i.textContentJoined[a].toLowerCase()));
      ...
      (Qt.defaults.viewerType = "flipbook"),
        ...
        (Qt.PAGE_MODE = { SINGLE: 1, DOUBLE: 2, AUTO: null }),
        (Qt.SINGLE_PAGE_MODE = { ZOOM: 1, BOOKLET: 2, AUTO: null }),
        (Qt.CONTROLSPOSITION = {
          HIDDEN: "hide",
          TOP: "top",
          BOTTOM: "bottom",
        }),
        (Qt.DIRECTION = { LTR: 1, RTL: 2 }),
        (Qt.PAGE_SIZE = { AUTO: 0, SINGLE: 1, DOUBLEINTERNAL: 2 }),
          ...
          for (
            var e,
              ...
              n = function (e, n, o, a, r) {
                return { x: e / t, y: n / i, w: o / t, h: a / i, dest: r };
              },
              o = [],
              a = 2;
            a < arguments.length;
              ...
              "true" !== e.data("parsed") &&
                ...
                e.hasClass("_df_book") ||
                  (e.hasClass("_df_thumb")
                    ? (e.attr("data-lightbox", "thumb"),
                      void 0 !== e.attr("thumb") &&
                        e.data("thumb", e.attr("thumb")))
                    : e.hasClass("_df_button")
                    ? e.attr("data-lightbox", "button")
                    : e.hasClass("_df_hidden")
                    ? e.attr("data-lightbox", "hidden")
                    : e.attr("data-lightbox", "custom")),
                null == e.data("option") &&
                  e.data("option", "option_" + e.attr("id")),
                void 0 !== e.attr("source") &&
                  e.data("source", e.attr("source")));
            });
        }),
      ...
      Kt.fn.extend({
        ...
        Kt(document).ready(function () {
          ...
          Qt.executeCallback("beforeDearFlipInit"),
            ...
            Qt.initUtils(),
            Qt.initControls(),
            e.on("click", ".df-element[data-lightbox]", function (e) {
