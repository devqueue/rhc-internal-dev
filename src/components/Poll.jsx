...
const Poll = ({ polls }) => {
  ...
  const options = [
    { label: poll.option1_en, value: poll.option1_en },
    { label: poll.option2_en, value: poll.option2_en },
    { label: poll.option3_en, value: poll.option3_en },
  ];
    ...
    <div className="w-full min-h-[424px] bg-white rounded-lg overflow-hidden shadow-md">
      ...
      <div className="w-full px-[30px]">
        ...
        {!voteCasted ? (
          ...
          <div className="flex flex-col gap-[16px]">
            {globalPoll.options && globalPoll.options.map((option) => {
              ...
              return (
                <div key={option.id} className="w-full">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-[24px]">
                    {percentage>0 && <div className={`${option.id===optionIdCasted?'bg-[#50917F]':'bg-[#8f9b97]'} h-[24px] rounded-full flex justify-end pr-1`} style={{ width: `${parseInt(percentage)}%`,alignItems:'center' }}>
