    ...
    <div className="w-full min-h-[424px] bg-white rounded-lg overflow-hidden shadow-md">
      ...
      <div className="w-full px-[30px]">
        <p className="mb-[30px] sm:text-base text-[10.5px]">
          ه⁠ا رأيك في تصميم واجهة المستخدم للبوابة الجديدة؟
        </p>
        ...
        <button
          onClick={handleVote}
          className={`h-[48px] w-full bg-[#50917F] my-[30px] flex justify-center items-center rounded-lg text-white ${voteCasted ? 'opacity-50 cursor-not-allowed' : ''}`}
          disabled={voteCasted}
        >
          تصويت
        </button>
