              ...
              return (
                <div key={option.id} className="w-full">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-[24px]">
                    <div className={`${option.id===optionIdCasted?'bg-[#50917F]':'bg-[#8f9b97]'} h-[24px] rounded-full flex justify-end pl-1`} style={{ width: `${parseInt(percentage)}%`,alignItems:'center' }}>
