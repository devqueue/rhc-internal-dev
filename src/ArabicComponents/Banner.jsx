...
const Banner = () => {
  return (
    <div className="w-full h-full relative">
      <img className="w-full h-full object-cover" src="/images/BannerImg.png" alt="" />
      <div className="absolute bottom-[-140px] left-0 w-[20vw] scale-x-[-1]">
        <img src="/images/HeroImgPattern.png" alt="" />
      </div>

      <div
          className="absolute top-[100px] lg:right-[44px] right-[5vw] xl:text-[40px] lg:text-[3vw] text-[24px] font-bold"
