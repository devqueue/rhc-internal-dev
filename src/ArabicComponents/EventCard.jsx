...
const EventCardAr = ({ start_time, end_time, Title, event_location_en }) => {
  ...
  return (
    ...
    >
      <div className=" h-[314px] lg:w-[312.5px] md:w-[312.5px] sm:w-[312.5px] xs:w-[280px] mt-[30px] ">
        ...
        >
          <span className="font-extrabold text-[#3B729C] text-3xl mt-7">
            {formatDate(start_time).day}
          </span>
        ...
        <div className="flex flex-col gap-[5px] p-[40px] max-h-[200px] mb-[50px] overflow-hidden">
          ...
          <div className="flex items-center w-[244.5px] h-[24px] gap-[15px] mb-2">
            ...
            <p className="lg:text-[18px] md:text-[18px] sm:text-[18px] xs:text-[16px] font-figtree font-normal leading-[28.8px] text-[#444444]" style={{direction: "ltr"}}>
              {normalizeDateTime(start_time)} - {normalizeDateTime(end_time)}
            </p>
          </div>
