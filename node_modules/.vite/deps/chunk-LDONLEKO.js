...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-ZXK4BUKG.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable()) {
    const controller = await import("./NestedAppAuthController-XKABZC6X.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-YNU2GAMZ.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.14.0 2024-05-07 *)
*/
//# sourceMappingURL=chunk-LDONLEKO.js.map
