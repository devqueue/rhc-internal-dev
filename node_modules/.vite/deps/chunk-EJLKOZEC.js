  ...
  async initialize() {
    ...
    try {
      if (typeof window !== "undefined") {
        ...
        try {
          if ((_a = bridgeProxy.getHostCapabilities()) == null ? void 0 : _a.queryAccount) {
...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-FPA6JKXC.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable()) {
    const controller = await import("./NestedAppAuthController-UAJIRI5U.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-CKURB7WZ.js");
    }
  } catch (e) {
  }
  return void 0;
...
var BrowserPerformanceClient = class extends PerformanceClient {
  constructor(configuration, intFields, abbreviations) {
    var _a, _b;
    super(configuration.auth.clientId, configuration.auth.authority || `${Constants.DEFAULT_AUTHORITY}`, new Logger(((_a = configuration.system) == null ? void 0 : _a.loggerOptions) || {}, name, version), name, version, ((_b = configuration.telemetry) == null ? void 0 : _b.application) || {
      appName: "",
      appVersion: ""
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.14.0 2024-05-07 *)
*/
//# sourceMappingURL=chunk-EJLKOZEC.js.map
